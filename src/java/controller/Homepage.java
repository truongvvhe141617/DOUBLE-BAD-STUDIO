...
//            int categoriesId = Integer.parseInt(request.getParameter("categoriesId"));
            ...
            List<Product> listP = hd.getAllProduct(pageIndex);
//            List<Product> listA = hd.sortProductASC(pageIndex);
//            List<Product> listB = hd.sortProductDESC(pageIndex);
             AdminDal ad = new AdminDal();      
            List<Categories> lc = ad.getAllCategory();
            request.setAttribute("listC", lc); 
            int totalPage = hd.totalPage();
